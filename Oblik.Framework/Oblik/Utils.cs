...
namespace Oblik
{
    ...
    public static class Utils
    {
        ...
        /// <param name="array"></param>
        /// <returns></returns>
        public static CalcUnitsStruct ToCalcUnits(byte[] array)
        {
        ...
        /// <returns></returns>
        public static byte[] CalcUnitsToByte(CalcUnitsStruct CalcUnits)
        {
        ...
        /// <param name="array"></param>
        /// <returns></returns>
        public static CurrentValues ToCurrentValues(byte[] array)
        {
        ...
        /// <returns></returns>
        public static SegmentsMapRec ToSegmentsMapRec(byte[] array)
        {
        ...
        /// <returns>Массив байт</returns>
        public static byte[] NetworkConfigToByte(NetworkConfig nc)
        {
            byte[] res = new byte[3];
            res[0] = nc.Addr;
